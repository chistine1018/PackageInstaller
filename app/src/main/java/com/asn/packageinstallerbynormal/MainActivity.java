...
public final class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/app-common-debug.apk";
        apk = new File(getApplicationInfo().sourceDir);  // myself app
        apk = new File(path); // test app agent
